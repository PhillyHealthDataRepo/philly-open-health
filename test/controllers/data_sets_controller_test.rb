...
class DataSetsControllerTest < ActionController::TestCase
  ...
  test "should create data_set" do
    assert_difference('DataSet.count') do
      post :create, data_set: { createdate: @data_set.createdate, description: @data_set.description, title: @data_set.title }
    end
  ...
  test "should update data_set" do
    patch :update, id: @data_set, data_set: { createdate: @data_set.createdate, description: @data_set.description, title: @data_set.title }
    assert_redirected_to data_set_path(assigns(:data_set))
  end
